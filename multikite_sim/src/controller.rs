...
const PITCH_REF_LIMIT_RAD: f64 = 14.0_f64.to_radians();
const ELEVATOR_PITCH_P: f64 = 0.6;
const ELEVATOR_PITCH_D: f64 = 0.18;
const TECS_ALTITUDE_ERROR_LIMIT_M: f64 = 25.0;
const TECS_THRUST_KINETIC_P: f64 = 0.04;
const TECS_THRUST_KINETIC_I: f64 = 0.008;
...
fn tecs_terms(
    ...
    let altitude_ref = altitude + altitude_error;
    ...
    let potential_energy_ref = gravity * altitude_ref;
    let potential_energy_error = potential_energy_ref - potential_energy;
    TecsTerms {
        altitude_ref,
        kinetic_energy,
        ...
        energy_balance_error: potential_energy_error - kinetic_energy_error,
    }
}
        ...
        kites: std::array::from_fn(|index| {
            ...
            let (
                ...
                let roll_feedforward = clamp(
                    (inertial_speed * inertial_speed * k_tg_y / params.environment.g.max(1.0e-6))
                        .atan(),
                    -ROLL_REF_LIMIT_RAD,
                    ROLL_REF_LIMIT_RAD,
                );
            ...
            let motor_torque = saturated_pi(
                ...
                SaturatedPiConfig {
                    ...
                    output_min: 0.0,
                    output_max: MOTOR_TORQUE_MAX_NM,
