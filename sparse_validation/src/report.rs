...
pub fn render_markdown_report(report: &ValidationSuiteReport) -> String {
    ...
    for case in &report.cases {
        ...
        out.push_str("| strategy | outcome | factor_ms | solve_ms | refactor_ms | refactor_speedup | residual | solution_error | stored_nnz | supernodes | max_width | inertia_match | two_by_two_pivots | delayed_pivots |\n");
        out.push_str("| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |\n");
