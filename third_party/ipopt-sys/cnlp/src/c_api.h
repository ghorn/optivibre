...
extern "C"
{
    ...
    enum CNLP_ApplicationReturnStatus
    {
        ...
        CNLP_MAXIMUM_WALLTIME_EXCEEDED=-5,
    ...
    typedef CNLP_Bool (*CNLP_Intermediate_CB)(
            ...
            CNLP_Index delta_x_count, const CNLP_Number* delta_x,
            CNLP_Index delta_s_count, const CNLP_Number* delta_s,
            CNLP_Index delta_y_c_count, const CNLP_Number* delta_y_c,
            CNLP_Index delta_y_d_count, const CNLP_Number* delta_y_d,
            CNLP_Index delta_z_l_count, const CNLP_Number* delta_z_l,
            CNLP_Index delta_z_u_count, const CNLP_Number* delta_z_u,
            CNLP_Index delta_v_l_count, const CNLP_Number* delta_v_l,
            CNLP_Index delta_v_u_count, const CNLP_Number* delta_v_u,
